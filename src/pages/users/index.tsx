...
import { Container } from '../accompany/AccompanyListPage.styles';
    ...
    <Page>
      <Container>
        <ProfileBoxWrap>
          {/* 프로필사진 -> 단일 컴포넌트 */}
          <ProfilePhotoBox>
            <ProfileCameraIcon imgSrc="/images/common/img_user_profile_tmp.png" state="modify" />
          </ProfilePhotoBox>
          {/* 프로필 설정영역 */}
          <div className="right">
            {/* 프로필 정보 */}
            ...
            <ProfileBox>
              ...
              <Link to={'/users/withdrawal'} className="deleteUser">
                계정 삭제하기
              </Link>
            </ProfileBox>
          </div>
